...
A simulação, portanto, foi realizada com um número arbitrário de
500 MNs do tipo S. Respeitando a proporção de 50 MN/mm de medula
espinhal \cite{cisi07}, esses neurônios foram distribuídos
em 10 mm. Sendo assim, 1000 CRs foram dispostos nesse comprimento
\cite{carr98}. O núcleo motor foi ativado por estímulos antidrômicos
supra máximos
para os axônios motores por 4 s, com taxas suficientes
para gerar os níveis
