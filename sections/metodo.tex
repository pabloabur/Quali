...
do link: https://dx.doi.org/10.17605/OSF.IO/QNMBH. Os códigos
...
quanto de depressão ocorrerá ($0\le\vari\le 1$), $\tau$ a 
...
Nas simulações descritas aqui, as entradas sinápticas agindo sob o
...
Além disso, denominando \Bi como o pico do módulo da resposta em frequência em
...
componentes em frequência de 6 Hz. Para representar o sinal que é 
entregue aos músculos pelos MNs recrutados, foi utilizado um trem de disparos
cumulativo (CST, do inglês \textit{cumulative spike train}) filtrado
