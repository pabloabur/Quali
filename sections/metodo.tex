...
foi utilizada para fazer com que as forças musculares geradas na ausência
e presença de inibição recorrente estivessem próximas, assim
como na seção \ref{sec:met_onion}.
Nesse caso, as amplitudes dos picos foram de 3300 e
1400 Hz em simulações com e sem CR, respectivamente. Nota-se,
ainda, que
...
\citeonline{walmsley78}. O coeficiente de variação da força muscular 
...
(metade da condutância), forte (dobro da condutância) e ausente.
Nesses três últimos casos, o valor dessas frequências de disparos foi
ajustado para que a força muscular gerada estivesse próxima à do primeiro
caso, como na seção \ref{sec:met_onion}. Em todos eles, os graus de 
...
em que $0\le\chi^2\le 1$. Sendo assim, valore mais próximos de 1 indicam
