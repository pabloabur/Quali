...
\citeonline{williams09} utilizaram as análises de densidade
espectral de potência de forças pequenas geradas por MNs
sincronizados em 10 Hz e de coerência córtico-muscular.
Para reproduzir os resultados encontrados por esses autores, um
cenário de simulação semelhante a este foi emulado no ReMoto.
