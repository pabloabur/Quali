...
5\% do MVC. Estudos na literatura
associam essa situação com a atividade de apenas 25\%
da população de MNs \cite{hoffer87,walmsley78}. Para reproduzir os
resultados encontrados por esses autores, um
cenário de simulação semelhante ao desses autores foi emulado.
...
para recrutar a quantidade de MNs associados com 5\% do MVC. Em
...
variaç\~{o}es na faixa de 10\% das geradas anteriormente.
...
Vale notar que, como \citeonline{williams09} consideraram
a distribuição da inibição recorrente como uniforme, a força da entrada
excitatória utilizada
foi escolhida para ativar o menor número possível de unidades motoras 
do tipo FR. Por fim, a população de CRs foi a mesma
utilizada anteriormente.

As simulações realizadas aqui tiveram duração de 9 s e passo de
integração de 0.05 ms. Para evitar a
interferências de respostas transitórias, apenas os últimos 
8 segundos da força gerada pelo ReMoto foram utilizados nas análises
de densidade espectral de potência, que
foi estimada por meio do método de 
Welch \cite{bendat11} com janelas de Hann e segmentos com 8000 amostras
sem superposição. Antes de realizar esses cálculos o nível médio
desse sinal foi removido. Esse procedimento foi repetido dez vezes
...
\begin{figure}[ht]
	\center
	\includegraphics[scale=0.5]{williams09b}
    \caption[Efeitos da ausência e presença da célula de Renshaw em
            espectros de potência.]{Efeitos da ausência e presença da
            célula de Renshaw em espectros de potência.
            da força muscular. Linhas pretas e vermelhas
...
\centering
    \begin{tabular}{c p{1cm} p{1cm} p{1cm} p{1cm}}\hline 
        \multirow{3}{*}{Situação da inibição recorrente} & \multicolumn{4}{c}{Amplitudes (Hz)} \\
         ...
         & DC & AC & DC & AC \\ \hline 
        Ausente & 146 & 75 & 685 & 150 \\
        Fraca & 200 & 75 & 815 & 150 \\
        Normal & 250 & 75 & 950 & 150 \\
        Forte & 368 & 75 & 1200 & 150 \\
	\hline
    \end{tabular}
\end{table}
...
\cite{walmsley78}. Essas simulações foram realizadas 5 vezes para cada
