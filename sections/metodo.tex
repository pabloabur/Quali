...
\centering
    \begin{tabular}{p{3.5cm} c c c p{3.5cm}}\hline 
        ...
        Tensão do \textit{twitch} (g) & 67$\pm$ 0.8 & 0.3$\pm$ 0.1 & 0.4$\pm$ 0.1 &
...
Ademais, os MNs também são ativados por um ruído excitatório
...
foi utilizada para compensar a redução de MNs recrutados 
...
foi de aproximadamente 3.8 vezes a das fibras descendentes. Essa proporção
é próxima à utilizada no trabalho de \citeonline{williams09} e foi
escolhida com o propósito de fazer com que a força gerada em ambos
os casos seja aproximadamente a mesma.
...
a configuração realizada aqui foi ajustada para que aproximadamente 75 MNs
disparassem.

As simulações realizadas aqui tiveram duração de 9 segundos e passo de
integração de 0.05 milissegundos. Para evitar a
...
Welch \cite{bendat10} com janelas de Hann e segmentos com 8000 amostras
sem superposição. Antes de realizar esses cálculos, todavia, o nível médio
desse sinal foi removido. Os resultados obtidos
foram comparados com os mostrados na Figura \ref{fig:met_williams09}.
