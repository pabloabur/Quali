...
(MN$\gamma$). O primeiro inicia diretamente as contrações de fibras musculares.
O conjunto de MNs$\alpha$ que ineram um único músculo é chamado de
...
O MN$\alpha$ é subdividido em diferentes tipos dependendo das propriedades dos
...
\cite{renshaw41} em um experimento com animais com as respectivas raízes
dorsais seccionadas cirurgicamente, quando foi demonstrado que que uma
estimulação antidrômica de axônios motores causavam um inibição de MNs$\alpha$
inervando os mesmos músculos (ou \textbf{homônimos}) e os músculos sinergistas.
Mais tarde, foi mostrado que essa inibição é mediada por meio de ramos
colaterais de axônios motores fornecendo entradas sinápticas excitatórias para
CRs, que por sua vez inibem diversos MNs que inervam o respectivo músculo
\cite{eccles54}.
...
Pode-se perceber que essa rede de neurônios contém um circuito disináptica que
...
são excitadas principalmente por MNs de músculos sinergistas e não por aqueles
...
Nota-se que nem todos os MNs dão origem a colaterais recorrentes. Apesar de
sempre estarem presentes em MNs inervando músculos do tornozelo e do joelho,
eles estão ausentes em MNs de músculos curtos plantares do pé
\cite{cullheim78}.
...
Vale ressaltar que MNs $\gamma$ apenas ocasionalmente dão origem a ramos
