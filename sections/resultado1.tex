...
Com esses parâmetros, torna-se possível parametrizar a AHP e a curva FxI.
...
\begin{itemize}
    ...
    \item \citeonline{friedman81}: Amplitude dos PIPS está correlacionada 
        com o tipo do MN, mas não com as resistências de entrada dos MNs 
        em cada tipo.
