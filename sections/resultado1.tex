...
\subsection{Parâmetros dos Motoneurônios}
Os parâmetros do modelo de MN e seus valores são apresentados na
Tabela \ref{tab:MN_params}. Vale notar que os valores de pico foram
condizentes com os apresentados por \citeonline{burke68}.

\begin{table}[ht!]
\caption{Parâmetros dos MNs. Valores são distribuídos linearmente pelo grupo
        de acordo com seus tamanhos.}
\label{tab:MN_params}
\centering
    \begin{tabular}{c c c c c c c}\hline 
        \multirow{2}{*}{Parâmetro} & \multicolumn{2}{c}{Tipo S} & \multicolumn{2}{c}{Tipo FR} &
            \multicolumn{2}{c}{Tipo FF} \\
        & de & até & de & até & de & até \\ \hline 
        Tempo de contração do \textit{twitch} (ms) & 110 & 58 & 55 & 30 & 47 & 20 \\
        Pico do \textit{twitch} (N) & 0.076 & 0.8 & 0.06 & 0.74 & 3.35 & 14.52 \\
        Velocidade de condução axonal (m/s) & 64 & 102 & 82 & 114 & 74 & 122 \\
	\hline
    \end{tabular}
\end{table}
...
A curva FxI obtida, por sua vez, é apresentada na Figura
...
desacordo com dados
fornecidos na literatura \cite{ross82,uchiyama03a}.
