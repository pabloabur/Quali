...
(1984, apud \citeauthor{windhorst90}, 1982, p. 154). Além disso,
nota-se que as CRs não apresentam \textit{overshoot} para
entradas com pequenas variações (círculos na Figura \ref{fig:met_dyn}),
como é o caso das usadas nas seções \ref{sec:danger} e \ref{sec:distort}.
