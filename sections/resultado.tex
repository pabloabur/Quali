...
resultados mais apropriados de acordo com a literatura foi 32 nS.
...
característica, entretanto, são especulativos \citeonline{mccurdy94}.
...
maiores \citeonline{mccurdy94}, mas estes se manifestaram esporadicamente
...
estática da CR. Menores $g_{max_{FF}}$, por sua vez, faria com que o efeito 
das CRs fosse muito baixo. Sendo assim, o valor de condutância adotado
fornece um equilíbrio razoável dos resultados.

\section{Validações}
Os resultados obtidos para o tempo de subida e tempo de meia vida são
