...
parâmetros serão ajustados baseados em:
...
\begin{itemize}
    \item \citeonline{mccurdy94}: Distribuição topográfica das amplitudes
        ...
        geral, independente do núcleo motor.
    %\item \citeonline{}: 
    \item \citeonline{uchiyama03a}: 
\end{itemize}

Para reproduzir o experimento como em \citeonline{mccurdy94}, as simulações
levaram em conta 180 pares, separados por distâncias entre 86 $\mu$m e
4.7 mm. Os MNs do núcleo motor simulado inervam o músculo gastrocnemius 
medial e, por isso, a distância que define se estes estão próximos ou
distantes um do outro é de 1 mm \cite{mccurdy94}.

O padrão de decaimento adotado foi o de uma gaussiana 

Na Figura \ref{fig:topography}, O resultado médio dos PIPS recorrentes
em pares próximos e distantes foi de , respectivamente.
